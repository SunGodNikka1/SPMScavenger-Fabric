...
Canonical location for **MRFC-1** engineering RFCs (Gate MRFC-1).
...
Workflow: `.agents/skills/minecraft-multi-agent-rfc/SKILL.md`  
Canonical procedure: `docs/agent-workflows/MINECRAFT_MULTI_AGENT_RFC_PLANNING.md`
