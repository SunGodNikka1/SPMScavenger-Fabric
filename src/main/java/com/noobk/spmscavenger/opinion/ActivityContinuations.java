 ...
 */
public record ActivityContinuations(ActivityContinuation explore, ActivityContinuation rest) {
    ...
    public static ActivityContinuations none() {
        return new ActivityContinuations(
                ActivityContinuation.notRunning(), ActivityContinuation.notRunning());
    }

    public static ActivityContinuations of(
            ActivityContinuation explore, ActivityContinuation rest) {
        return new ActivityContinuations(explore, rest);
    }
}
