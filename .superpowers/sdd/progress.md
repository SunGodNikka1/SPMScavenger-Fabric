...
| **GAO-8** | **Next** — observable expression product/design frontier; implementation not authorized | RFC phased table |
...
**GA-OPINION:** GAO-0 through GAO-7 (**CLOSED**) + GAO-4.1 + RET-GAO-1 **static ACCEPT** (581 tests, MAIBS); runtime reserved for engine/SPM/perf `RUNTIME_QUESTION`s only — not a default feature gate.
