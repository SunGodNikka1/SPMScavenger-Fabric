...
GA-OPINION: GAO-0 through GAO-3 `IMPLEMENTED / STATIC VERIFIED` — episode routing, REST claims,
`AffectiveState`, `OpinionMemory`, `IdleOpportunityPolicy` (EXPLORE/REST utility scoring only);
GAO-4 frontier;
