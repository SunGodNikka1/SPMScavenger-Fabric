...
| **V3 Village Work** | **PRE-LOCK LOCKED** — D-VR-080…083; **task-52 (D-VR-084) IMPLEMENTED / STATIC-BEHAVIORAL ACCEPT + R1** (1357 tests); **authorize task-53 / V3-A** | `task-52-report.md`; `RFC-VILLAGE-RAID-AUTONOMOUS-PROGRESSION.md` |
