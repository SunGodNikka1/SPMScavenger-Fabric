...
summon villager ~-9 ~ ~ {VillagerData:{profession:"minecraft:toolsmith",level:2,type:"minecraft:plains"},PersistenceRequired:1b,CustomName:'"VRT2 Toolsmith"',Tags:["vrt2","vrt2_merchant"]}
summon villager ~9 ~ ~ {VillagerData:{profession:"minecraft:fletcher",level:1,type:"minecraft:plains"},PersistenceRequired:1b,CustomName:'"VRT2 Fletcher"',Tags:["vrt2","vrt2_merchant"]}
